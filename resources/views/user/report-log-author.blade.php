                                    ...
                                    <div class="message-wrap ">
                                                ...
                                                <div class="media msg">
                                                    <a class="pull-left" href="#">
                                                        ...
                                                        <img class="media-object" data-src="holder.js/64x64" alt="64x64"
                                                            ...
                                                            @else
                                                            <img class="media-object" data-src="holder.js/64x64" alt="64x64" style="width: 32px; height: 32px;" src="{{asset('assets/images/logo/favicon.png')}}">
                                                        @endif
                                                    </a>
                                        ...
                                        <form action="{{route('send.reports')}}" method="post">
                                            ...
                                            <div class="send-wrap ">
                                                ...
                                                <textarea name="report" class="form-control send-message" rows="3" cols="10"
