                                        ...
                                        <div class="modal-body">
                                            <ul class="list-group">
                                                <li class="list-group-item">Thumbnail :
                                                    <img src="{{asset('assets/images/project/'.$dep->image)}}" alt=""
                                                         class="img-responsive">
                                                </li>
                                                <li class="list-group-item">Salary :
                                                    <strong>{{$dep->salary or '-'}} {{$basic->currency}}</strong></li>
                                                <li class="list-group-item">Deadline :
                                                    <strong>{{date('d F, Y', strtotime($dep->deadline)) }} </strong>
                                                </li>
                                                <li class="list-group-item">Experience :
                                                    <strong>{{$dep->experience or '-'}}</strong></li>
                                                <li class="list-group-item">Description : <br>
                                                    <p>{!!  $dep->description or '-'!!}</p></li>
                                                <li class="list-group-item">keywords :
                                                    <strong>{{$dep->keywords or '-'}}</strong></li>
                                            </ul>
                                        </div>
                                        <div class="modal-footer">
                                            <form role="form" method="POST"
