    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item start @if(request()->path() == 'admin/categories') active open @endif ">
                    <a href="{{route('admin.category')}}" class="nav-link "><i class="fa fa-tags"></i><span
                                class="title"> Job Category</span></a>
                </li>

                <li class="nav-item
                        @if(request()->path() == 'admin/projects-requests') active open
                        @elseif(request()->path() == 'admin/projects-approved') active open
                        @endif">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item  ">
                            <a href="{{route('admin.approved.projects')}}" class="nav-link ">
                ...
                <li class="nav-item start @if(request()->path() == 'admin/reports') active open @endif ">
                    <a href="{{route('admin.reports')}}" class="nav-link "><i class="fa fa-flag"></i>
                        <span class="title"> All Milestone Report</span>
                        @php $newReports  = \App\Report::where('is_read',0)->count(); @endphp
                        <span class="badge badge-danger">{{$newReports}} new</span>
                    </a>
                </li>
                ...
                <li class="nav-item start @if(request()->path() == 'admin/subscribers') active open @endif">
                    <a href="{{route('manage.subscribers')}}" class="nav-link "><i class="fa fa-thumbs-up"></i><span
                ...
                <li class="nav-item
                                ...
                                @elseif(request()->path() == 'admin/how-it-works') active open
                                ...
                                @elseif(request()->path() == 'admin/short-about') active open
                                @elseif(request()->path() == 'admin/manage-slider') active open
                                @elseif(request()->path() == 'admin/featured') active open
                            @endif">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item  ">
                            <a href="{{route('short.about')}}" class="nav-link ">
                                <i class="fa fa-info-circle"></i>
                        ...
                        <li class="nav-item  ">
                            <a href="{{route('service-control')}}" class="nav-link ">
                        ...
                        <li class="nav-item  ">
                            <a href="{{route('featured')}}" class="nav-link ">
                                <i class="fa fa-arrow-right"></i>
