...
@section('body')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <h3 class="page-title uppercase bold">Edit {{$service->title}}
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal" action="{{ route('featured.update',$service->id) }}" method="post" role="form" enctype="multipart/form-data">
