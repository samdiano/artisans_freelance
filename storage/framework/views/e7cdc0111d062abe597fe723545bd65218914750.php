                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="login-admin login-admin">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail"
                                        ...
                                        <?php else: ?>
                                            <img style="width: 200px"
                                                 src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=Company Logo"
                                                 alt="...">
                                        <?php endif; ?>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail"
                                        ...
                                        <?php else: ?>
                                            <img style="width: 200px"
                                                 src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=Company Cover"
                                                 alt="...">
                                        <?php endif; ?>
                                    </div>
                                    <div class="fileinput-preview fileinput-exists thumbnail"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12 "><strong
                                                style="text-transform: uppercase;">Company Name
                                            :</strong></label>
                                    <div class="col-md-12">
                                        <input type="text"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12 text-uppercase"><strong>Company Tagline
                                            :</strong></label>
                                    <div class="col-md-12">
                                        <input type="text"
                                               class="<?php echo e($errors->has('company_tagline') ? ' is-invalid' : ''); ?>"
                                               name="company_tagline" value="<?php echo e($user->company_tagline); ?>" required
                                               placeholder="Enter a short tagline here.">
                                        <?php if($errors->has('company_tagline')): ?>
                                            <span class="invalid-feedback error-color red">
                                                     <strong><?php echo e($errors->first('company_tagline')); ?></strong>
                                                </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <label class="col-md-12"><strong>Business Category :</strong></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <label class="col-md-12"><strong>Company Phone :</strong></label>
                                    <div class="col-md-12">
                            ...
                            <label class="col-md-12"><strong>Company Description :</strong>
                                <small>Write down about your Company</small>
                            </label>
                            <div class="col-md-12 ">
                                <div class="textColor white-bg">
                                        <textarea name="company_description" id="area1"
                                                  rows="15"> <?php echo e($user->company_description); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <label class="col-md-12"><strong>Company Website :</strong></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="col-md-12"><strong>Company Location:</strong></label>
                                    <div class="col-md-12">
                                        <select name="country"
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('assets/admin/js/nicEdit-latest.js')); ?>"></script>
    <script>
